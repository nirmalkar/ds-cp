...
console.log('Solution for input numArr1 (sumZeroWhileLoop)', sumZeroWhileLoop(numArr1))
console.log('Solution for input numArr2 (sumZeroWhileLoop)', sumZeroWhileLoop(numArr2))
console.log('Solution for input numArr3 (sumZeroWhileLoop)', sumZeroWhileLoop(numArr3))
console.log('Solution for input numArr4 (sumZeroWhileLoop)', sumZeroWhileLoop(numArr4))
console.log('Solution for input numArr4 (sumZeroWhileLoop)', sumZeroWhileLoop(numArr4))
console.log('Solution for input numArr5 (sumZeroWhileLoop)', sumZeroWhileLoop([]))
